 ...
 * loan. {@code usdEquivalentAmount} is deliberately absent -- always
 * computed by {@code EmployeeLoanServiceImpl} from {@code amount} and
 * {@code exchangeRateToUsd}, per the project's currency rule.
 */
@Getter
@Setter
@NoArgsConstructor
