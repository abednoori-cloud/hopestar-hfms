...
/**
 * Input for creating a new employee. {@code employeeCode} is deliberately
 * absent — always system-generated by {@code EmployeeService} (e.g.
 * {@code EMP-2026-000001}), per the approved business rules.
 * {@code usdEquivalentSalary} is likewise absent — always computed by
 * the service layer via the shared {@code MoneyUtil.resolveExchangeRateToUsd}
 * / multiply pattern, never trusted from a caller.
 */
@Getter
@Setter
@NoArgsConstructor
